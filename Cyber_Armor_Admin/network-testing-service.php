...
<body class="hold-transition sidebar-mini">
        ...
        <div class="modal-content">
          ...
          <form name="updatestatusform" id="updatestatusform" type="post">
            <div class="modal-body">
              <div class="frm-status"></div>
              <div class="mb-3">
                <label for="network_scope" class="form-label">Status Names</label>
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <div class="row">
                <h1>Network Penetration Testing Requests Detail</h1>
      ...
      <section class="content">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Network Penetration Testing Requests</h3>
          </div>
          <div class="card-body">
            <div class="top-panel">
  ...
  <script>
    ...
    function editData(user_data) {
      ...
      $('#network_scope').val(user_data.network_scope);
    ...
    function submitUserData() {
      ...
      let input_data_arr = [
        ...
        document.getElementById('network_scope').value,
