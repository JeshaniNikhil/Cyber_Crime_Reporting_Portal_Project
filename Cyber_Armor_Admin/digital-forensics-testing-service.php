      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <div class="row">
                <h1>Digital Forensics Testing Requests Detail</h1>
      ...
      <section class="content">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Digital Forensics Testing Requests</h3>
          </div>
          <div class="card-body">
            <div class="top-panel">
