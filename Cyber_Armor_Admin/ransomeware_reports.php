      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <div class="row">
                <h1>RansomWare Attacks Reports</h1>
              </div>
            </div>
            <div class="col-sm-6">
      ...
      <section class="content">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">RansomWare Attacks Reports</h3>
          </div>
          <div class="card-body">
            <div class="top-panel">
    ...
    $(document).ready(function () {
      ...
      $("#updatestatusform").submit(function (e) {
        ...
        $.ajax({
          ...
          contentType: false,
          dataType: "json",
          url: "update_ransomware_status.php",
